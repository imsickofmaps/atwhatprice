...
"""
    ...
    def create_task(self, task_id=None, description=None, hidden=False, thumbnail=None,
            ...
            on_submit_fn=None, on_submit_fns=None):
        """
        ...
        :param on_submit_fns: Optional dictionary mapping form names to functions. When a form
            is submitted by the human, if it has a name as provided by the ``set_form_name()``
            function, the name will be looked up in this dictionary. If the name is found,
            its function will be called. If not, then the function provided by ``on_submit_fn``
            will be called. The function takes the same arguments as ``on_submit_fn``.
...
class Session(object):
    ...
    * camera: True if the client app has a camera.
    ...
    def add_submit_button(self, text="", value=""):
        """
    ...
    def add_image_submit_button(self, url, value, decorated=True):
        """
    ...
    def add_list_button(self, name, value, text, subtitle=None):
        """
    ...
    def add_camera_button(self, name):
        """
